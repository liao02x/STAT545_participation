...
|-----------------------|---------------|
| __data__              | `gapminder` |
| __aesthetic mapping__ | `aes(x=gdpPercap, y=lifeExp)` |
| __geometric object__  | `geom_point` |
| scale                 | log |
...
|-----------------------|---------------|
| __data__              | `gapminder` |
| __aesthetic mapping__ | `aes(x=lifeExp)` |
| __geometric object__  | `geom_histogram` |
| scale                 | linear |
| statistical transform | none |
...
|-----------------------|---------------|
| __data__              | `gapminder` |
| __aesthetic mapping__ | `aes(x=continent, y=pop)` |
...
|-----------------------|---------------|
| __data__              | `gapminder` |
| __aesthetic mapping__ | `aes(x=year, y=lifeExp)` |
| __geometric object__  | `geom_line` |
| scale                 | log |
| statistical transform | none |
...
|-----------------------|---------------|
| __data__              | `gapminder` |
| __aesthetic mapping__ | `aes(x=continent)` |
