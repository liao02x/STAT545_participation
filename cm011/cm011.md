...
```
    ...
    ## Warning in a * 1:3: 长的对象长度不是短的对象长度的整倍数
...
```
    ...
    ## Warning in a[1:n] <- 1:3: 被替换的项目不是替换值长度的倍数
